...
export const SORT_KEY = {
  most_popular: "salesLast72Hours",
  recent_asks: "lastLowestAskTime",
  recent_bids: "lastHighestBidTime",
  average_price: "averageDeadstockPrice",
  total_sold: "deadstockSold",
...
export const FOOTER_DESC = {
  airJordan: {
    ...
    more: `The Air Jordan 1s almost didn't get off the ground as NBA commissioner David Stern threatened to fine Jordan for wearing them since they did not meet the league's strict standards. These Jordan shoes received the nickname "Notorious" because of the controversy. Jordan continued to wear them, however, and their popularity led to the release of the Air Jordan 2 by Nike in 1986. Through the years, Jordan retro shoes have continued their popularity thanks to a variety of designs, including the Space Jam Air Jordan, released in 1995 in conjunction with the movie. Nike reissued that style of Jordan shoe as a Retro model in 2009. New Jordans continue to be released, with the 2019 Air Jordan Bred 11 coming in as the best-selling sneaker in history.`,
    series: {
      1: {
        normal:
